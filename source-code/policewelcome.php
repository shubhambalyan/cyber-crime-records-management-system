...
<html>
    ...
    <body>
        ...
        <center> <h2 style="font-size:40px;">WELCOME POLICE &nbsp;<i><?php echo $login_user; ?></i></h2></center>
        <a href="policeviewupdate.php?q=<?php echo $login_user; ?>"> <div id="a"> </div>  </a>
        <p style="margin-top:-45px;font:bold; font-size: 25px; margin-left: 160px;">VIEW AND UPDATE MY DETAILS</p>
        <a href="opencomplaint.php?q=<?php echo $login_user; ?>"><div id="b"> </div></a>
